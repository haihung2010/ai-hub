#!/usr/bin/env bash
# Launch 12B Q4_K_M as TEXT-ONLY chatbot on port 8080 — P2 variant.
# P2: CTX_SIZE=4096 (vs P0=8192) — smaller ctx, less KV memory.
# For use in Q4-combo config (12B text + E2B multimodal).
# Usage: ./start_12b_q4_p2.sh
set -euo pipefail
...
ALIAS=${ALIAS:-local-gemma4-12b-q4-text-p2}
LOG_FILE=${LOG_FILE:-/tmp/aihub-llama-12b-q4-p2.log}
PID_FILE=${PID_FILE:-/tmp/aihub-llama-12b-q4-p2.pid}
